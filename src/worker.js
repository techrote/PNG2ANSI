...
self.onmessage=async event=>{
  ...
  try{
    ...
    self.postMessage({id,type:"result",ansi:result.ansi.buffer,png,width:result.width,height:result.height,glyphCount:result.glyphCount},[result.ansi.buffer,png]);
